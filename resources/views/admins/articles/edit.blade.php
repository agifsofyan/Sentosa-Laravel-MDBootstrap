                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-2 mb-3">
                                ...
                                <div class="material-switch pull-right bord">
                                    <input type="checkbox" name="statuses" value="{{ $data->statuses }}" {{ $data->statuses=="" ? '' :  "checked=checked" || $data->statuses=="hidden" ? '' :  "checked=checked" || $data->statuses=="publish" ?  "checked=checked" : '' }}>
                                    {{-- @if ($data->statuses === "hidden")
